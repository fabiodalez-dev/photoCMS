...
ADD COLUMN `og_image_path` VARCHAR(500) DEFAULT NULL,
ADD COLUMN `schema_type` VARCHAR(100) DEFAULT 'ImageGallery',
ADD COLUMN `schema_data` TEXT DEFAULT NULL,
ADD COLUMN `canonical_url` VARCHAR(500) DEFAULT NULL,
ADD COLUMN `robots_index` TINYINT(1) DEFAULT 1,
ADD COLUMN `robots_follow` TINYINT(1) DEFAULT 1;
