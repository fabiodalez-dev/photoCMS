...
(8, 'Masonry Portfolio', 'masonry-portfolio', 'Layout masonry responsivo per portfolio - desktop 4 colonne, tablet 3, mobile 2', '{"layout":"grid","columns":{"desktop":4,"tablet":3,"mobile":2},"masonry":true,"photoswipe":{"loop":true,"zoom":true,"share":true,"counter":true,"arrowKeys":true,"escKey":true,"bgOpacity":0.9,"spacing":0.1,"allowPanToNext":true}}', '["photoswipe"]', '2025-08-25 14:21:20'),
(9, 'Slideshow Minimal', 'slideshow-minimal', 'Slideshow minimalista con controlli essenziali', '{"layout":"slideshow","columns":{"desktop":1,"tablet":1,"mobile":1},"masonry":false,"photoswipe":{"loop":true,"zoom":true,"share":false,"counter":false,"arrowKeys":true,"escKey":true,"bgOpacity":0.95,"spacing":0.05,"allowPanToNext":false}}', '["photoswipe"]', '2025-08-25 14:21:20'),
