/**
 * Stewart & Partners - Work Page Clone
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================
    // FILTER HOVER EFFECTS (logo change)
    // ============================================
    
    const filterItems = document.querySelectorAll('.toggle-cat_item');
    const headLogo = document.querySelector('.head-logo');
    const defaultLogoSrc = 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe06c/66601c7c6b0d48cf88bbe090_logo-full.svg';
    
    const categoryLogos = {
        'blue': 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe075/6660aed251e7422053e969cf_Architectural.svg',
        'orange': 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe075/6660aec93b86acfd7f21b423_Infrastructure.svg',
        'yellow': 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe075/6660aec07b0dd1b54560b9c2_Interior.svg',
        'green': 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe075/6660aeb49e976330d9e740dc_Digital.svg',
        'violet': 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe075/6660ae976c058a1d4460b6cc_Research.svg',
        '#000000': 'https://cdn.prod.website-files.com/66601c7c6b0d48cf88bbe06c/66601c7c6b0d48cf88bbe08f_logo-icon.svg'
    };
    
    filterItems.forEach(item => {
        const hoverColor = item.getAttribute('hover-color');

        item.addEventListener('mouseenter', function() {
            if (headLogo && categoryLogos[hoverColor]) {
                headLogo.src = categoryLogos[hoverColor];
            }
        });

        item.addEventListener('mouseleave', function() {
            if (headLogo) {
                headLogo.src = defaultLogoSrc;
            }
        });
    });
